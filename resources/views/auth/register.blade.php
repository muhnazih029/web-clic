        ...
        <div class="grid grid-rows-[1fr_1fr] md:grid-cols-[1fr_1fr] gap-4">
            ...
            <x-auth.form-section action="" >
                    <div class="flex flex-col space-y-3 ">
                        ...
                        <x-auth.text-input type="password" name="token" placeholder="Registration Token" id="token"  />
                    </div>
                    <div class="mt-10 text-center ">
                        <x-auth.submit>Login</x-auth.submit>
                        <p>Already have account? <a href="{{ route('login') }}" class="font-[Galyon%20Book] font-semibold text-primary">Login</a></p>
                    </div>
            </x-auth.form-section>
